...
template <class T>
string array_twod_string(const T**twod, int*sizes);
...
// template <class T>
// string array_twod_string(T**twod, int*sizes){
//   string array_twod_string = " ";
//   T** row_walker = twod;
//   T*column_walker;
//   T* sizes_w = sizes;
//   while(*row_walker!= nullptr){
//     column_walker = *row_walker;
//     array_twod_string += array_string(column_walker, *sizes_w);
//     array_twod_string += '\n';
//     row_walker++;
//     sizes_w++;
//   }
//   return array_twod_string;
// }
#endif